...
1. Penalidade de estados ruins mais branda

- Observar e reportar o efeito de trocar $r_{\text{bad}}=-10$ para $r_{\text{bad}}=-1$.

1. Transformação afim nas recompensas
...
1. Analise o impacto do fator de desconto ($\gamma$):
...
1. Analise o impacto do comprimento do episódio ($T$):
...
1. Analise o impacto do parâmetro $\epsilon$ :
...
1. Compare o desempenho do algoritmo **MC $\epsilon$-guloso** com **MC com inícios exploratórios**.
